...
import com.example.imageclassification.ml.ModelMobilenetv21V2
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        make_prediction.setOnClickListener(View.OnClickListener {
            ...
            val model = ModelMobilenetv21V2.newInstance(this)
            var tImage = TensorImage(DataType.FLOAT32)
            tImage.load(resized)
            var tensorImage = tImage.tensorBuffer



           // var byteBuffer = tensorImage.get


// Creates inputs for reference.
            //val inputFeature0 = TensorBuffer.createFixedSize(intArrayOf(1, 224, 224, 3), DataType.FLOAT32)
            //Log.d("shape 1 bb ", byteBuffer.toString())
            //Log.d("shape 2 if", inputFeature0.buffer.toString())
...
// Runs model inference and gets result.
            ...
            var max = outputFeature0.floatArray.size
            Log.d("getmax:", max.toString())
